...
**검증 로직 개선 (2025-11 ~ 2025-12, PR #124, #160, #161, #163):**
...
- **섹션 기호 색상 코드 지원** (PR #160, #161): `§Y$variable$`, `§H£energy£`, `§BA£variable£` 패턴을 올바른 변수로 인식합니다.
- **변수만으로 구성된 텍스트 감지** (PR #163): AI가 게임 변수만 있는 텍스트를 수정하는 것을 방지합니다.
