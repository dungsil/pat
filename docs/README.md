...
**주요 개선 사항:**
- **키 단위 음역 모드** (신규, 2025-12-15): 왕조 이름 키(`dynn_*`, `dynnp_*`)와 고유명사 접미사(`*_adj`, `*_name`) 자동 음역 지원
...
### 최신 업데이트
- **2025-12-15**: 키 단위 음역 모드 추가 (왕조 이름 키 및 고유명사 접미사 자동 감지)
...
**최종 업데이트:** 2025-12-15 | **문서 버전:** 1.2.1
