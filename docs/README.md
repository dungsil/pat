...
- **번역 거부 처리 개선** (2025-12-18): 중복 제거 및 이슈 자동 닫기 기능, stale 파일 문제 해결
- **대문자 포맷팅 태그 지원** (2025-12-18): AI 프롬프트에 `#!` (capitalized) 태그 추가
- **키 단위 음역 모드** (2025-12-15): 왕조 이름 키(`dynn_*`, `dynnp_*`)와 고유명사 접미사(`*_adj`, `*_name`) 자동 음역 지원
- **GitHub MCP 서버 우선순위** (2025-12-17): AGENTS.md에 GitHub MCP 서버 도구 사용 가이드라인 추가
- **번역 거부 자동 이슈 등록**: AI 번역 거부 항목을 GitHub Issues로 자동 생성, 모드별 그룹화 및 레이블 태깅
...
- **2025-12-17**: GitHub MCP 서버 도구 우선순위 가이드라인 추가
- **2025-12-15**: 키 단위 음역 모드 추가, Paradox 형식 후행 텍스트 지원
- **2025-12-08**: 번역 거부 자동 이슈 등록, 캐시 시스템 개선
- **2025-12-01**: 주간 문서 자동화 워크플로우, 검증 시스템 대폭 개선
